...
export interface LocalGameState {
  hLines: (Player | null)[][];      // gridSize rows x (gridSize-1) cols — value = player who drew it
  vLines: (Player | null)[][];      // (gridSize-1) rows x gridSize cols — value = player who drew it
